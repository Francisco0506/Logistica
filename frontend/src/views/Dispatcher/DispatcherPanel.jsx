...
export default function DispatcherPanel() {
  ...
  // Orden de entrega calculado por el optimizador (OR-Tools), no el orden crudo de la BD
  const bySecuencia = (a, b) => (a.secuencia_ruta ?? 0) - (b.secuencia_ruta ?? 0);
  const ordersOf = (id) => orders.filter(o => o.truck === id).sort(bySecuencia);
